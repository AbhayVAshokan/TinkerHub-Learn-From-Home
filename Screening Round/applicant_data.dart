...
class ApplicantData {
  final String name;              // applicant's name
  ...
  // Function to append new interests to the interests list
  void addStacks(List<String> newInterests) {
    interests = [...interests, ...newInterests];
  }

  // Function to set whether the person is learner or mentor
